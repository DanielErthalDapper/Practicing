...
{
    public Coordenador(Long id, Nome nome, CPF cpf, Telefone telefone, DataDeNascimento dataDeNascimento, Senha senha, Email email, Login login, Salario salario, CargaHoraria cargaHoraria, TipoContrato tipoContrato)
    {
        super(id, nome, cpf, telefone, dataDeNascimento, senha, email, login, salario, cargaHoraria, tipoContrato, NivelAcesso.COORDENADOR);
    }
}
